...
onMounted(() => {
  ...
  const scroller = document.querySelector('.pane .scrollable') as HTMLElement | null;
  const outer = document.querySelector('.scrollable-pane') as HTMLElement | null;
      ...
      <div class="projects scrollable">
        ...
        <div class="project mb">
          ...
          <div class="description">
            ...
            <div class="detail">A project written using Nuxt3 and the GitHub REST API to automatically send invitation emails for joining a GitHub organization.</div>
            <a class="visit link" target="_blank" href="https://madewithai.netlify.app">examine the project ></a>
          </div>
        </div>
        <div class="project mb">
          <div class="image-wrapper">
            <a href="https://retrocommerce.vercel.app" target="_blank">
              <NuxtImg format="webp" width="300" src="/images/retrocommerce.png" />
            </a>
          </div>
          <div class="description">
        ...
        <div class="project mb">
          <div class="image-wrapper">
            <a href="/images/woonuxt-bg.png" target="_blank">
              <NuxtImg format="webp" width="300" src="/images/woonuxt.png" />
            </a>
          </div>
          <div class="description">
            ...
            <div class="detail">
              Developed by
              <a class="visit link" target="_blank" href="https://github.com/scottyzen">@scottyzen</a>
              using Nuxt, GraphQL and WooCommerce, and I'm continuing to develop the second interface demo.
            </div>
        ...
        <!--<div class="project mb">
          <div class="image-wrapper">
            <a href="/images/terodon.png" target="_blank">
              <NuxtImg format="webp" width="300" src="/images/terodon.png" />
            </a>
          </div>
          <div class="description">
            ...
            <a class="visit link" target="_blank" href="https://terodon.com/"
        ...
        <div class="project mb">
          <div class="image-wrapper">
            <a href="/images/reybul-bg.png" target="_blank">
              <NuxtImg format="webp" width="300" src="/images/reybul.png" />
            </a>
          </div>
          <div class="description">
        ...
        <div class="project mb">
          <div class="image-wrapper">
            <a href="/images/zackha.jpg" target="_blank">
              <NuxtImg format="webp" width="300" src="/images/zackha.jpg" />
            </a>
          </div>
          <div class="description">
            <div class="projectname">zackha.com</div>
            <div class="detail">My personal website has been developed using Nuxt2.</div>
        ...
        <div class="project mb">
          <div class="image-wrapper">
            <a href="https://github.com/zackha/woocommerce-admin/" target="_blank">
              <NuxtImg format="webp" width="300" src="/images/github.png" />
            </a>
          </div>
          <div class="description">
            ...
            <div class="detail">
              ...
              <a class="visit link" target="_blank" href="https://github.com/marmelab/react-admin">React Admin</a>
            </div>
        ...
        <div class="project mb">
          <div class="image-wrapper">
            <a href="https://github.com/zackha/supaAuth/" target="_blank">
              <NuxtImg format="webp" width="300" src="/images/supaAuth.png" />
            </a>
          </div>
          <div class="description">
            ...
            <div class="detail">
              A
              <a class="visit link" target="_blank" href="https://nuxt.com/">Nuxt3</a>
              +
              <a class="visit link" target="_blank" href="https://supabase.com/">Supabase</a>
              starter template. Add Login and Register page into your Nuxt 3 project using Supabase authentication.
            </div>
        ...
        <div class="project">
          ...
          <div class="description">
            ...
            <div class="detail">
              ...
              <a class="visit link" target="_blank" href="https://github.com/marmelab/react-admin">react-admin</a>
              , the frontend framework for building admin applications on top of REST/GraphQL services.
            </div>
...
.bottom.scrollable-pane:after,
.top.scrollable-pane:before {
  height: 0;
}
.bottom .arrow-down,
.top .arrow-up {
